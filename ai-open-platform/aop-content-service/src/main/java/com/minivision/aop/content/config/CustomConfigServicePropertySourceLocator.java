...
@Order(-1)
@Slf4j
public class CustomConfigServicePropertySourceLocator extends ConfigServicePropertySourceLocator {
  ...
  public org.springframework.core.env.PropertySource<?> locate(
      ...
      log.info("Fetching config from server at: " + properties.getRawUri());
      try {
          ...
          for (String label : labels) {
              ...
              if (result != null) {
                  log.info(String.format("Located environment: name=%s, profiles=%s, label=%s, version=%s, state=%s",
                          result.getName(),
